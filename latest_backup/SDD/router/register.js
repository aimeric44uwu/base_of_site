...
router.post('/',checkUnAuthenticated, (req, res, next) => {
	...
	if (!personInfo.email || !personInfo.firstname || !personInfo.lastname|| !personInfo.phonenumber || !personInfo.password || !personInfo.passwordConf || !personInfo.adress ) {
		res.send();
	} else {
		if (personInfo.password == personInfo.passwordConf) {
			...
			res.send({ "Success": "Les mot de passes ne correspondent pas" });
		}
	}
});
